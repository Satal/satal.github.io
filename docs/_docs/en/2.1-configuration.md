...
TeXt use CDN[^cdn] for speed improvements, You can choose [BootCDN](https://www.bootcdn.cn/) (default) or [unpkg](https://unpkg.com/) as your site’s CDN provider, both of them are open source and free.
